...
namespace SentenceSimilarityExample
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\Vinay Gupta\Downloads\sentence_similarity_500.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Regression.Trainers.SentenceSimilarity(labelColumnName: @"Label", sentence1ColumnName: @"Sentence1", sentence2ColumnName:@"Sentence2");
